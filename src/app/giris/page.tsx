...
type AuthMode = "select" | "phone" | "phone-otp" | "email";
...
export default function GirisPage() {
  ...
  const handleEmailSubmit = async () => {
    ...
    if (error) {
      ...
      setError("");
      alert("E-posta adresine giris linki gonderildi. Lutfen kontrol et.");
    }
    setLoading(false);
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-text-secondary">
              ...
              {mode === "phone-otp" && "Dogrulama kodunu gir"}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mb-3 text-sm text-text-tertiary">
                    +90{phone} numarasina gonderilen 6 haneli kodu gir.
                  </p>
                  <Input
                    type="text"
                    placeholder="000000"
            ...
            {mode === "email" && (
              <div className="space-y-4">
                ...
                <p className="text-center text-xs text-text-tertiary">
                  E-posta adresine tek kullanimlik giris linki gonderilecek.
                </p>
              </div>
            )}
          </div>
